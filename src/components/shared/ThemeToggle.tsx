    ...
    >
      <AnimatePresence mode="wait">
        {theme === "dark" ? (
          ...
          >
            <Sun className="w-5 h-5 text-zinc-400 group-hover:text-primary transition-colors" />
          </motion.div>
        ) : (
          <motion.div
            key="moon"
            ...
            transition={{ duration: 0.2 }}
          >
            <Moon className="w-5 h-5 text-zinc-500 group-hover:text-primary transition-colors" />
          </motion.div>
        )}
      </AnimatePresence>
